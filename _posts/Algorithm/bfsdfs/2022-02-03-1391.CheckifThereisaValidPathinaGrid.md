---
layout: single
title: "[DFS] #1391. Check if There is a Valid Path in a Grid."
categories: ["bfsdfs"]
...
class Solution {
private:
    unordered_map<int,int>traffic[7] = {% raw %}{{},{{3,3},{2,2}},{{1,1},{0,0}},{{3,1},{0,2}},{{0,3},{2,1}},
                                        {{3,0},{1,2}},{{1,3},{2,0}}};
    vector<pair<int,int>>guide = {{-1,0},{1,0},{0,-1},{0,1}}; {% endraw %}
public:
    int n,m;
